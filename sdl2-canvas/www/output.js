...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'output.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'output.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'output.temp.asm.js';
...
STATICTOP = STATIC_BASE + 17904;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "output.html.mem" : null;




var STATIC_BUMP = 17904;
...
Module['wasmTableSize'] = 12608;

Module['wasmMaxTableSize'] = 12608;
