...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'dom.wast';
  var wasmBinaryFile = 'dom.wasm';
  var asmjsCodeFile = 'dom.temp.asm.js';
...
var ASM_CONSTS = [function($0) { Module.STDWEB.tmp = Module.STDWEB.to_js( $0 ); },
 function($0, $1, $2, $3) { Module.STDWEB.from_js($0, (function(){var listener = Module.STDWEB.to_js($1); Module.STDWEB.to_js($2). addEventListener (Module.STDWEB.to_js($3), listener); return listener ;})()); },
 ...
 function($0) { Module.STDWEB.from_js($0, (function(){return window ;})()); },
 function($0, $1) { Module.STDWEB.to_js($0). alert (Module.STDWEB.to_js($1)); }];
...
Module['wasmTableSize'] = 10112;

Module['wasmMaxTableSize'] = 10112;
