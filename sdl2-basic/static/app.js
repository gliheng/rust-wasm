...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '/home/clojure/github/rust-wasm/sdl2-basic/target/wasm32-unknown-emscripten/debug/deps/wasm_demo.data';
    var REMOTE_PACKAGE_BASE = 'wasm_demo.data';
...
Module['FS_createPath']('/', 'assets', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_/home/clojure/github/rust-wasm/sdl2-basic/target/wasm32-unknown-emscripten/debug/deps/wasm_demo.data');

    };
    Module['addRunDependency']('datafile_/home/clojure/github/rust-wasm/sdl2-basic/target/wasm32-unknown-emscripten/debug/deps/wasm_demo.data');
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 143139, "filename": "/assets/icon.png"}], "remote_package_size": 143139, "package_uuid": "8cf7ce6a-4fce-4785-826c-f3c488db1ae7"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'wasm_demo.wast';
  var wasmBinaryFile = 'wasm_demo.wasm';
  var asmjsCodeFile = 'wasm_demo.temp.asm.js';
