...
var ASM_CONSTS = [function($0, $1, $2) { $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){var url = ($1); var cbk = ($2); fetch (url). then (rsp => rsp.arrayBuffer ()). then (ab => new Uint8Array (ab)). then (function (data){var p = "tmp_img" ; FS.writeFile (p , data , {encoding : "binary"}); cbk (p); FS.unlink (p);}, function (){err ();});})()); },
...
Module['wasmTableSize'] = 148480;

Module['wasmMaxTableSize'] = 148480;
